...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Message Board</h1>
    <a href="localhost" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
</div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <div class="dropdown no-arrow">
                    <a href="localhost" class="dropdown-toggle" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                        ...
                        <a href="localhost" class="dropdown-item" >Action</a>
                        <a href="localhost" class="dropdown-item" >Another action</a>
                        <div class="dropdown-divider"></div>
                        <a href="localhost" class="dropdown-item" >Something else here</a>
                    </div>
                </div>
            </div>
            <!-- Card Body -->
